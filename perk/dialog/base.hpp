...
class XD_PerkDialog {
    ...
    class controls {
        ...
        class AvailablePointsValueText: BBRscStructuredText {
            idc = 1;
            x = 0.673;
            y = 0.05;
            w = 0.052;
