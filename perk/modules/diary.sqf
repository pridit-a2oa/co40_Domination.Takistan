...
["Perks", [
    ...
    "<br />This is the main progression system within the mission, providing support options and abilities as reward for effort.",
    format [
    ...
    "<br />Role based perks must be <marker name=''>unlocked in sequence</marker>, starting with the first one at the top and then continuing down.",
    "<br />Unlocked perks <marker name=''>do not persist</marker> across roles. On rejoin you receive points to re-allocate dependant on score.",
