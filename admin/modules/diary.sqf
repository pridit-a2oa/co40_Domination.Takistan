...
["Admin", [
    ...
    "- There isn't a response after already pinging.<br />",
    "This facility exists to try and ensure the wellbeing and integrity of the experience for everyone.<br />",
    "Abuse of pinging/disregarding the above <marker name=''>will</marker> lead to a ban."
