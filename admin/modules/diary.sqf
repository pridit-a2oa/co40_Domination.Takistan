...
["Admin", [
    ...
    "<br />If there is a mission breaking issue, severe bug, cheater, or active griefer please <marker name=''>report</marker> these to an admin in real-time.",
    ...
    "<br />- Someone is being mean/rude (with exception of extreme toxicity) to you or others over voice or text.",
