...
["Research & Development", [
    ...
    "<br />You are able to <marker name=''>construct</marker>, or work towards being able to construct (by researching), most (not all) OPFOR vehicles.",
    "<br />To research vehicles you will need to find them out in the world and place them on the R&amp;D pad, alive.",
