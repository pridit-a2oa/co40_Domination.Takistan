...
if (isServer) then {
...

    {
        ...
        X_JIP setVariable [
            QGVAR(accolade_units),
            (X_JIP getVariable QGVAR(accolade_units)) + [_entity],
            true
        ];
...
if (hasInterface) then {
    waitUntil {
        ...
        && {[{alive _x} count (X_JIP getVariable QGVAR(accolade_units)), count GVAR(accolade_types)] call BIS_fnc_areEqual}
    };
    ...
    } forEach (X_JIP getVariable QGVAR(accolade_units));
