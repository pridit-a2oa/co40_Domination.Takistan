...
["Vehicle Service", [
    ...
    "<br />For balancing reasons, vehicles <marker name=''>cannot be rearmed</marker> in the field and so must rearm at their facility.",
    "<br />To discourage abandonment on the pad, vehicles <marker name=''>cannot be disembarked</marker> while actively being serviced.",
    if !(isNil QMODULE(vehicle_loadout)) then {"<br />Vehicles with loadout changes <marker name=''>must be rearmed</marker> at one of these facilities to equip the new armament."} else {""},
