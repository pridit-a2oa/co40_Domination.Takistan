/**
 * Weather Module (Handler)
 *
 * version 2.0 by Engima of Ostgota Ops
 * http://www.armaholic.com/page.php?id=16096
 */
...
// (Suggested value: 20).
_maxWeatherChangeTimeMin = _minWeatherChangeTimeMin;
