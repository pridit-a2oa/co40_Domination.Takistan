...
if (hasInterface) then {
    ...
    _trigger setTriggerStatements [
        ...
        "d_action = player addAction ['Disarm IED' call d_fnc_common_RedText, 'ied\functions\fn_disarm.sqf', [player] call d_fnc_ied_near, 10, false, true, '', 'player == vehicle player && {speed player == 0}']",
