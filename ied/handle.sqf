...
if (hasInterface) then {
    ...
    _trigger setTriggerStatements [
        ...
        "d_action_ied = player addAction ['Defuse IED' call d_fnc_common_RedText, 'ied\functions\fn_disarm.sqf', [player] call d_fnc_ied_near, 10, false, true, '', '[] call d_fnc_common_ready && {[speed player, 0] call BIS_fnc_areEqual}']",
