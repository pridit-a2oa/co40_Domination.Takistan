...
_vehicle addAction [format ["%1 Menu" call FUNC(common,OliveText), getText (configFile >> "cfgVehicles" >> (typeOf _vehicle) >> "displayName")], __function(show), _vehicle, -3, false, true, "", "!(player in _target)"];