...
["Main Missions", [
    ...
    "Main Missions are towns occupied by Takistan forces, and are the main antagonist of the mission.<br />",
    ...
    "In order to complete a Main Mission the following conditions <marker name=''>must</marker> be met:<br />",
