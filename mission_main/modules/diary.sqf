...
["Main Targets", [
    ...
    "<br />Main Targets are towns heavily occupied by Takistani forces, which you are tasked with <marker name=''>seizing</marker> control of.",
    "<br />They are also referred to as Main Missions or, known more commonly as, the ""AO"" (area of operations).",
    "<br />These targets are dynamically generated, and <marker name=''>do not</marker> have a defined end, with old completed targets periodically recycled.",
    "<br />In order to complete one of these targets the following conditions <marker name=''>must</marker> be met:",
