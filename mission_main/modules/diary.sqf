...
["Main Missions", [
    ...
    "Main Missions are towns heavily occupied by Takistani forces, which you are tasked with seizing control of.<br />",
    "They are also referred to as Main Targets or, more commonly known as, the ""AO"" (area of operations).<br />",
    "These missions are dynamically generated, and <marker name=''>do not</marker> have a defined end, with old completed targets periodically recycled.<br />",
    "In order to complete one of these missions the following conditions <marker name=''>must</marker> be met:<br />",
    format ["- Alive infantry <marker name=''>cannot</marker> exceed %1.", GVAR(mission_main_threshold_infantry)],
