...
if (alive _vehicle && {count crew _vehicle > 0} && {{!isPlayer _x} count crew _vehicle > 0}) exitWith {};
if (alive _vehicle && {faction _vehicle == "BIS_TK"} && {!(_vehicle getVariable QGVAR(rebuilt))}) exitWith {};
