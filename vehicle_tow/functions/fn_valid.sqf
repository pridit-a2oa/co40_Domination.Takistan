...
_vehicle = (typeOf (vehicle player)) == GVAR(vehicle_tow_type);
...
_position_front = (vehicle player) distance (_tow modelToWorld [0, if (typeOf _tow == "C130J_US_EP1") then {17} else {7}, 0]) > 8;
