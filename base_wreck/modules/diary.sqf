...
["Wrecks", [
    ...
    "Some vehicles produce a <marker name=''>rebuildable</marker> wreck when they are <marker name=''>destroyed<marker>.<br />",
    "Vehicle wrecks which are not being actively lifted will <marker name=''>always</marker> be visible on the map.<br />",
    ...
    "Once a vehicle has been rebuilt it will be <marker name=''>automatically moved</marker> into an empty adjacent hangar.<br />",
